          ...
          <div className="max-w-lg">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">
                Track Prices Like Never Before
              </h2>
              <p className="text-xl mb-8 text-green-50">
                Access real-time price data from Egyptian markets and make informed purchasing decisions.
              </p>
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span className="text-green-50">Real-time price tracking</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span className="text-green-50">Historical price analysis</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span className="text-green-50">Store availability alerts</span>
                </div>
              </div>
            </motion.div>
          </div>
